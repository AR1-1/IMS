       ...
       List<Article> articleList = articleRepository.findArticlesByStockThreshold(3);
        ...
        articleList.forEach(article -> {
            ...
            if (notificationRepository.countNotificationByArticleId(article.getArticleId()) == 0){
                ...
                notification.setMessage("Stock is getting low of article no "+article.getArticleId());
...
//        SaveNotificationShechudler sv = new SaveNotificationShechudler();
//        sv.findAllByArticles(2);
//
//        SaveNotification.findAll
